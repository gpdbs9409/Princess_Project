...
export const ONBOARDING_ENDINGS: OnboardingEnding[] = [
  ...
  },
  {
    ...
    description: "(예정) 문화 자본 엔딩 설명 카피 준비 중이에요.",
  },
  {
    id: "knowledge",
    ...
    description: "(예정) 지식 자본 엔딩 설명 카피 준비 중이에요.",
  },
  {
    id: "economy",
    capitalKey: "economy",
    ...
    description: "(예정) 경제 자본 엔딩 설명 카피 준비 중이에요.",
  },
  {
    id: "physical",
    capitalKey: "physical",
    ...
    description: "(예정) 신체 자본 엔딩 설명 카피 준비 중이에요.",
  },
  {
    id: "language",
    capitalKey: "language",
    ...
    description: "(예정) 언어 자본 엔딩 설명 카피 준비 중이에요.",
  },
  {
    id: "symbol",
    capitalKey: "symbol",
    ...
    description: "(예정) 상징 자본 엔딩 설명 카피 준비 중이에요.",
  },
];
