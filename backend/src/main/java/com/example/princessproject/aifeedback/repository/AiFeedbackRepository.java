...
public interface AiFeedbackRepository extends JpaRepository<AiFeedback, Long> {
    ...
    Optional<AiFeedback> findTopByUserIdAndProjectIdAndFeedbackDateAndFeedbackTypeOrderByCreatedAtDesc(
    ...
    List<AiFeedback> findByUserIdAndProjectIdAndFeedbackTypeOrderByFeedbackDateAscCreatedAtAsc(
