...
| 참가비 | 20,000원 (반환 없음) |
| 예치금 | 100,000원 |
| 환급 | 주 6일 이상 인증 성공 시 25,000원 |
| 성장 축 | 아비투스 7자본 중 3개 선택 + 공통과제 3종 |

**아비투스 7자본**: 심리 · 문화 · 지식 · 경제 · 신체 · 언어 · 상징
**공통과제 3종**: 독서 · 공부(데일리 필수) · 주간 회고(선택, 점수·환급 미반영)
...
- 공통과제 3종 안내 (독서·공부는 데일리 필수, 주간 회고는 선택)
...
선택 공통과제로, 작성한다면 **주 1회만** 기록합니다. 같은 주에 다시 저장하면 그 주 회고가
갱신되고 새 카드가 쌓이지 않습니다.

1. 이번 주 회고
2. 다음 주 계획

주간 회고는 작성하지 않아도 되며 점수와 환급 판정에 포함되지 않습니다.
...
| 탭 | 기능 |
| --- | --- |
| 참가자 (기수별 주간 관리) | 주간 성공일수, 요일별 이행, 환급 대상 판정, 지급 체크, MVP 지정, CSV 내보내기 |
...
현재는 두 경로 모두 지원하며 촬영 날짜는 검사하지 않습니다. 사진 내용의 적합성은 AI Vision
판정 결과로 운영진이 확인합니다.
...
판정 대상은 DAILY 개인 미션과 그날의 독서·공부입니다. 주간 회고는 제외합니다.
...
매주(WEEKLY) 미션은 2026-08-29에 스펙아웃되어 점수·환급 어디에도 쓰이지 않습니다.
